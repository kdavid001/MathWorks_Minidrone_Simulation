...
2. Ensure you have **MATLAB (R202X)** installed along with the **Simulink Support Package for PARROT Minidrones**.
3. Open `[Your_Main_Model_Name].slx`.
4. Run the `[Your_Init_Script].m` file to load the workspace variables.
5. Execute the simulation to view the 3D visualization and flight data scopes.
...
---
*Built by David and Erica — Aspiring Deep Learning & Reinforcement Learning Engineer.*
