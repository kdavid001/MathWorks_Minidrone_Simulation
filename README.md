...
https://github.com/user-attachments/assets/5d580704-731a-4dab-a5cb-c39fb60a286a
...
* **Takeoff State:** Stabilizing altitude to a certain height before initializing vision algorithms.
...
* **Performance:** The algorithm successfully navigated a simple track using simple algorithms/methods in 53seconds without losing the path lock.
* **Bottlenecks Addressed:** "Initially struggled with the drone over-correcting on sharp corners, but resolved this by dampening the derivative gain on the yaw controller."
